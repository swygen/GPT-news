...
TOKEN = "7907881079:AAEgzRaNWpa4VCt01qk6846BnVXcxfPXj8w"  # <-- এখানে তোমার টোকেন বসাও
...
def start(update: Update, context: CallbackContext):
    ...
    agreement_msg = (
        ...
        "GPT VERSION 2.0 NEWS UPDATE  বট ব্যবহার করতে হলে আমাদের Terms & Conditions মেনে নিতে হবে।\n"
...
def button_handler(update: Update, context: CallbackContext):
    ...
    if query.data == 'accept_agreement':
        ...
        query.edit_message_text(
            "✅ Agreement Accepted!\n\n"
            "আপনি কি GPT VERSION 2.0 এর সকল নতুন আপডেট নোটিফিকেশন পেতে চান? নিচের অপশন থেকে নির্বাচন করুন।",
            reply_markup=InlineKeyboardMarkup(keyboard)
        )
